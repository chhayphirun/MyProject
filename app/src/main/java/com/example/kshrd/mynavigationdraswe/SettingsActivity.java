...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     */
    static  SwitchPreference swSubscribe;
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            swSubscribe= (SwitchPreference) findPreference("notifications_new_message");
            // Bind the summaries of EditText/List/Dialog/Ringtone preferences
            // to their values. When their values change, their summaries are
            // updated to reflect the new value, per the Android Design
            // guidelines.
        ...
        public void onActivityCreated(@Nullable Bundle savedInstanceState) {
            ...
            swSubscribe.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    Log.e("ooooo",newValue.toString());
                    if (!(boolean)newValue){
                        // Subscribe OneSignal
